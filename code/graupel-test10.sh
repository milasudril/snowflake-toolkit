...
__targets_rel/graupel_generate2 --seed=123 --E_0=12 --decay-distance=50 --overlap-max=3 \
	--scale=[1,0.25] --merge-offset=0.2 --D_max=30 --fill-ratio=0 --dump-stats=graupel-stats3.txt \
	--statefile-out=3.h5 --dump-geometry-ice=test13.graupel --projection=cylindrical --pmap=vbar.png
