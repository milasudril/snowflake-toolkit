...
% A deformation is a cell array with elements parameter and distribution, followed by
% arguments. Deformation can for example take the form
%
%  {{'L','gamma',1,0.25},{'a','custom','distribution_file.txt'}}
%
% Here distribution_file.txt is a tab delimited text file with the first column containing
% the value, and the second containing the frequency.
%
